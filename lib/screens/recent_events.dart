        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              ...
              Image.asset('assets/1.jpg', width: 350),
              SizedBox(
                height: 16,
              ),
              Image.asset('assets/2.jpg', width: 350),
              SizedBox(
                height: 16,
              ),
              Image.asset('assets/3.jpg', width: 350),
              SizedBox(
                height: 16,
              ),
              Image.asset('assets/4.jpg', width: 350),
              SizedBox(
                height: 16,
              ),
              Image.asset('assets/5.jpg', width: 350),
              SizedBox(
                height: 16,
