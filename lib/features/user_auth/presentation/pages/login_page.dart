...
import 'package:flutter_firebase/features/user_auth/presentation/pages/homepage_screens/home_page.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Gradlink", style: TextStyle(color: Colors.white)),
        centerTitle: true,
      ),
